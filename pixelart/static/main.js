...
function updateBtn() {
	...
	if (isSubscribed) {
		pushButton.textContent = 'Disable Live Updates';
	} else {
		pushButton.textContent = 'Enable Live Updates';
	}
...
function updateSubscriptionOnServer(subscription) {
	...
	var xmlhttpsubstr = new XMLHttpRequest();
	xmlhttpsubstr.onreadystatechange = function() {
